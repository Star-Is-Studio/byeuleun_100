...
아래에는 빗썸 API를 활용하기 위한 함수와
몇가지 지표 계산 함수들이 구현되어 있습니다.
함수 안의 내용은 참고만 하시고 굳이 이해하지 않아도 됩니다.
사용만 하면 되는거죠 ^^

API_KEY와 SECRET_KEY는 빗썸에서 발급받은 키값을 넣어주세요!
...
myBithumb.py 공통 모듈은 클래스 수강 기간이 끝나더라도 업데이트가 필요한 경우가 있기에
아래 링크에 권한 요청 해주시면 됩니다!
https://drive.google.com/file/d/1DYLN8VsfQh012IH3Hhb3qid1MQZXHFA4/view?usp=sharing

물론 제 패키지 코드나 다른 클래스를 통해 myBithumb.py 구글 드라이브 링크가 이미 있으신 분은 필요 없는 링크입니다. :)
...
# 빗썸 API 키 설정
API_KEY = '8b1fb752089d55e3d9a358e2d6b74d92c186d8df6789'
SECRET_KEY = 'NmMyZTRjYmY4ZjQ2OTk2OWI3NTcwZDllNTM5MGE5YTU1YWU1ZGNiNjQ0OWFjOThlZDFkZjYyOGRiOTA='
